function res = decideStimuliDividedSRDx5( field )
    ...
    % Get data
    data = 1*gauss(params.n_fieldsize-1, params.inp_pos, params.inp_str, params.inp_sig, params.inp_inh) ...
